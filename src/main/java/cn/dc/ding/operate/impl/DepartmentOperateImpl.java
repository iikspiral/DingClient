package cn.dc.ding.operate.impl;
...
import cn.dc.ding.operate.DepartmentOperate;
 ...
 */
public class DepartmentOperateImpl extends Operate implements DepartmentOperate {

    public DepartmentOperateImpl(HttpClientFactory factory) throws Exception {
        super(factory);
    }
