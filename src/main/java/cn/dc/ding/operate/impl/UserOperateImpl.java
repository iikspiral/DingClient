...
import cn.dc.ding.operate.UserOperate;
 ...
 */
public class UserOperateImpl extends Operate implements UserOperate{

    public UserOperateImpl(HttpClientFactory factory) throws Exception {
        super(factory);
    }
